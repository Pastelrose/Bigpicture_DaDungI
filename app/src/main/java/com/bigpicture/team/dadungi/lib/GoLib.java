package com.bigpicture.team.dadungi.lib;
...
import com.bigpicture.team.dadungi.EnterpriseInfoActivity;
import com.bigpicture.team.dadungi.ESCRegisterActivity;
import com.bigpicture.team.dadungi.ProfileActivity;
...
public class GoLib {
    ...
    public void goBestFoodRegisterActivity(Context context) {
        Intent intent = new Intent(context, ESCRegisterActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        context.startActivity(intent);
    }
     ...
     */
    public void goEnterpriseInfoActivity(Context context, int infoSeq) {
        Intent intent = new Intent(context, EnterpriseInfoActivity.class);
//        intent.putExtra(EnterpriseInfoActivity.INFO_SEQ, infoSeq);
        context.startActivity(intent);
    }
}
