...
import com.bigpicture.team.dadungi.Constant;
...
public class MapListAdapter extends RecyclerView.Adapter<MapListAdapter.ViewHolder> {
    ...
    private ArrayList<EnterpriseInfoItem> itemList;
     ...
     */
    public MapListAdapter(Context context, int resource, ArrayList<EnterpriseInfoItem> itemList) {
     ...
     */
    public void setItemList(ArrayList<EnterpriseInfoItem> itemList) {
        this.itemList = itemList;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final EnterpriseInfoItem item = itemList.get(position);
